...
1. Реализовать сущности мероприятия и организаторы
    a. Мероприятия имеют поля: 
        ...
        - Дата проведения
        - Организаторы (В поле Организаторы можно указать несколько мероприятий. Для ввода можно, но не обязательно, использовать Select2)
        - Описание мероприятия
    б. Организаторы имеют поля:
        - ФИО (обязательное поле)
        - E-mail (обязательное поле)
        - Телефон
        - Проводимые мероприятия (В поле Проводимые мероприятия можно указать несколько Организаторов. Для ввода можно, но не обязательно, использовать Select2)
